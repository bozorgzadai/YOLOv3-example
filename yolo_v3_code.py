"""
YOLOv3 - Example
Website: https://robotech-academy.com
"""
...
def load_data_and_preprocess(address):
    ...
    h, w = img.shape[:2]
    preprocessed_image = cv2.dnn.blobFromImage(img, scalefactor= 1/255, size= (416, 416), swapRB = True, crop = False)
...
def show_results(img, classIDs, confidences, boxes, labels):
    ...
    for i in idxs.flatten():
        ...
        cv2.putText(img, text, (x, y-10), cv2.FONT_HERSHEY_PLAIN, 1.2, (255, 255, 255), 2)
...
img, pre_img, h, w = load_data_and_preprocess("pic2.jpg")
labels, net = read_model_and_label(r"yolo files\coco.names", r"yolo files\yolov3.weights", r"yolo files\yolov3.cfg")
